...
final_fig_dir = r'F:\Retina_project\Dataset_public\figures\figure_8'
...
# fig,ax = utils.visualize_kernel(actor_network)
fig,ax = utils.visualize_kernel_with_line(actor_network,final_fig_dir)

# fig.savefig(os.path.join(final_fig_dir,'actor_kernel.svg'))
